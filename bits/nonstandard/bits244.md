...
| y-value |    9bfff ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff 63ffaab2 |
+---------+-------------------------------------------------------------------------+
| (G/2).x |                                                                       1 |
| (G/2).y |    fffff ffffffff ffffffff ffffffff ffffffff ffffffff fffffffe ffff7401 |
+---------+-------------------------------------------------------------------------+
```
...
G=E(0xcffffffffffffffffffffffffffffffffffffffffffffffffffff2fff8e41,0x9bfffffffffffffffffffffffffffffffffffffffffffffffffff63ffaab2)
h=1
