...
+---------+-------------------------------------------------------------------------+
| x-value |        1 9fffffff ffffffff ffffffff ffffffff ffffffff ffffffff 2ffed399 |
| y-value |        1 c7ffffff ffffffff ffffffff ffffffff ffffffff ffffffff 1bfeb6af |
+---------+-------------------------------------------------------------------------+
| (G/2).x |        1 ffffffff ffffffff ffffffff ffffffff ffffffff fffffffe fffe8e42 |
| (G/2).y |                                                                       2 |
+---------+-------------------------------------------------------------------------+
```
...
G=E(0x19fffffffffffffffffffffffffffffffffffffffffffffff2ffed399,0x1c7ffffffffffffffffffffffffffffffffffffffffffffff1bfeb6af)
h=1
