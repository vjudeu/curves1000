...
| y-value |        2 dfffffff ffffffff ffffffff ffffffff ffffffff a3ffe655 |
+---------+----------------------------------------------------------------+
| (G/2).x |                                                              1 |
| (G/2).y |        7 ffffffff ffffffff ffffffff ffffffff fffffffe ffffb891 |
+---------+----------------------------------------------------------------+
```
...
G=E(0x67fffffffffffffffffffffffffffffffffffffff2fffc5f6,0x2dfffffffffffffffffffffffffffffffffffffffa3ffe655)
h=1
