...
+---------+-------------------------------------+
| x-value |     2fff ffffffff ffffffff cffffc9c |
| y-value |     9bff ffffffff ffffffff 63fff4ee |
+---------+-------------------------------------+
| (G/2).x |     ffff ffffffff fffffffe ffffeddc |
| (G/2).y |                                   2 |
+---------+-------------------------------------+
```
...
G=E(0x2fffffffffffffffffffcffffc9c,0x9bffffffffffffffffff63fff4ee)
h=1
